...
const FiltersProperties = ({
  ...
  const onChangeHandle = (
    ...
    if (
      (e.target.name == "deleted" && e.target.value == "0") ||
      e.target.value == ""
    ) {
    ...
    <>
      ...
      <div className="flex flex-row flex-wrap justify-center items-baseline gap-5 mb-8 mt-3">
        <Label htmlFor="floors">
          <small className="text-sm  uppercase text-center block">pisos</small>
          <Input
            min={0}
            name="floors"
            type="number"
        ...
        <Label htmlFor="bathrooms">
          <small className="text-sm  uppercase text-center block">baños</small>
          <Input
            name="bathrooms"
            min={0}
            type="number"
      ...
      <div className="flex flex-row flex-wrap justify-center items-baseline gap-5 mb-8">
        ...
        <Button onClick={() => setFilters(formData)} variant="outline">
          Filtrar <Search className="mx-2" />{" "}
        </Button>
      </div>
    </>
  );
