...
//   propertyId: number;
//   setCalification?: Dispatch<boolean>;
// }) => {
//   const [generalCalification, setGeneralCalification] = useState<number>(0);

//   const [myCalification, setMyCalification] = useState<
//     PropertyCalificationType | undefined
//   >(undefined);
...
//               (calification) => calification.user_id === res.data.id
//             );
...
//       calification: e,
//     });
//     if(setCalification) setCalification(true);
...
//         />
//         {generalCalification == 0 && (
//           <p className="text-sm font-thin">Sin calificación</p>
//         )}
//       </div>
